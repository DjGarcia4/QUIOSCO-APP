  ...
  return (
    <div className=" shadow p-5 mb-3 flex gap-10 items-center rounded-md">
      ...
      <div>
        <button
          type="button"
          className="bg-yellow-400 hover:bg-yellow-500 text-white w-full mt-1 p-3 font-bold rounded-md flex items-center gap-4"
          onClick={() => {
            handleChangeModal();
        ...
        <button
          type="button"
          className="bg-red-400 hover:bg-red-600 text-white w-full p-3 font-bold rounded-md mt-3 flex items-center gap-4"
          onClick={() => {
